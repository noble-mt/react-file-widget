  ...
  const posterUrl = id
    ? (() => {
        switch (config?.videoProps?.posterQuality ?? '') {
          case 'low':
            return `https://i.ytimg.com/${vi_format}/${id}/sddefault.${format}`;
          case 'medium':
            return `https://i.ytimg.com/${vi_format}/${id}/mqdefault.${format}`;
          default:
            return `https://i.ytimg.com/${vi_format}/${id}/hqdefault.${format}`;
        }
      })()
    : '';
